...
// Pinned repos — mirrors the 5 portfolio projects on the site
const FALLBACK_REPOS: Repo[] = [
  {
    id: 1,
    name: "cwbms",
    html_url: "#work",
    description: "CVHAI San Pedro Water Billing System — residents view bills & pay online via PayMongo. Laravel, deployed on DigitalOcean.",
    language: "PHP",
    stargazers_count: 0,
    forks_count: 0,
    topics: ["laravel", "tailwindcss", "paymongo", "digitalocean"],
  ...
  },
  {
    ...
    name: "cho-hris",
    html_url: "#work",
    description: "City Health Office HRIS — stores 201 files & permits to leave. Laravel 12 + Inertia React + TypeScript, drop-in deploy.",
    language: "TypeScript",
    stargazers_count: 0,
    forks_count: 0,
    topics: ["laravel", "inertia", "react", "typescript"],
  ...
  },
  {
    ...
    name: "mrsia-console",
    html_url: "#work",
    description: "Measles–Rubella Reporting Console 2026 — real-time campaign reporting across health centers. React + Supabase.",
    language: "TypeScript",
    stargazers_count: 0,
    forks_count: 0,
    topics: ["react", "supabase", "vite", "exceljs"],
  ...
  },
  {
    ...
    name: "choims",
    html_url: "#work",
    description: "City Health Office Inventory Management System — assets & consumables across a LAN. 6 role tiers, approval workflows.",
    language: "PHP",
    stargazers_count: 0,
    forks_count: 0,
  ...
  },
  {
    ...
    name: "quadshot-pos",
    html_url: "#work",
    description: "Point-of-sale for QuadShot Café — full menu, order queue, sales & expenses. React + Supabase on Vercel.",
    language: "TypeScript",
    stargazers_count: 0,
    forks_count: 0,
